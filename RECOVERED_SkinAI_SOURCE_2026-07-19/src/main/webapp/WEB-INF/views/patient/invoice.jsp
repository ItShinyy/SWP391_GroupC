    ...
    <div class="table-container bg-white shadow-sm rounded-4 p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="${pageContext.request.contextPath}/patient/payment?action=info" class="btn btn-outline-primary">
                    <i class="fas fa-credit-card me-2"></i>Thanh Toán Mới
                </a>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="uuid-text text-secondary font-monospace small" title="${payment.paymentId}">
