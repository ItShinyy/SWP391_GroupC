        ...
        <div class="card shadow-sm mb-4 border-0 rounded-4 bg-light">
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/admin/audit-logs" method="get" class="row g-3 align-items-center">
                    ...
                    <div class="col-md-2">
                        <input type="text" name="startDate" class="form-control" placeholder="Từ ngày" onfocus="(this.type='date')" onblur="(this.type='text')" value="${param.startDate}">
                    </div>
                    <div class="col-md-2">
                        <input type="text" name="endDate" class="form-control" placeholder="Đến ngày" onfocus="(this.type='date')" onblur="(this.type='text')" value="${param.endDate}">
                    </div>
                            ...
                            <c:forEach var="log" items="${auditLogs}">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/admin/audit-logs/detail?id=${log.id}" class="btn btn-sm btn-outline-primary">
