    ...
    <input type="hidden" name="csrf_token" value="${sessionScope.csrfToken}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="newPassword" class="form-control border-start-0 ps-0" placeholder="Nhập mật khẩu" required autocomplete="new-password" minlength="${passwordMinLength}" data-password-pattern="${passwordPattern}" data-password-message="${passwordMessage}" data-password-confirmation="confirmPassword" data-password-mismatch-message="${passwordMismatchMessage}">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fa-solid fa-lock"></i></span>
                                <input type="password" name="confirmPassword" class="form-control border-start-0 ps-0" placeholder="Nhập mật khẩu" required autocomplete="new-password" minlength="${passwordMinLength}">
                            </div>
                        </div>
