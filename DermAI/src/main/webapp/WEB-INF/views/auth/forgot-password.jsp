...
<body class="d-flex align-items-center justify-content-center vh-100 bg-light">
    ...
    <input type="hidden" name="csrf_token" value="${sessionScope.csrfToken}">
                        <div class="mb-4">
                            <label class="form-label text-muted fw-semibold small">Nhập Email hoặc Tên đăng nhập</label>
                            <div class="input-group">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fa-solid fa-user"></i></span>
                                <input type="text" name="identifier" class="form-control border-start-0 ps-0" placeholder="name@example.com hoặc username" required>
                            </div>
                        </div>
