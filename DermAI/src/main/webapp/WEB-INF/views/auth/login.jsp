...
<html lang="vi">
    <head>
        ...
        <title>Đăng nhập - DermAI</title>
        <meta name="description" content="Đăng nhập vào DermAI để sử dụng AI chẩn đoán bệnh da liễu.">
    ...
    <body class="d-flex align-items-center justify-content-center min-vh-100" style="background:#F6F8FA;">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="text-center mb-4">
                        <a href="${pageContext.request.contextPath}/home" class="text-decoration-none">
                            <h1 class="fw-bold m-0" style="color: var(--skin-primary, #198754); font-family: 'Fragment Mono', sans-serif;">Skin<span style="color:#146c43;">AI</span></h1>
                        </a>
                        <p class="text-muted mt-2 mb-0">Đăng nhập để sử dụng AI chẩn đoán</p>
                    </div>
                    ...
                    ═══════════════════════════════════════════════════════ -->
                    <div class="card shadow-sm border rounded-4 p-4 p-md-5" style="border-color:#E5E7EB !important; background:#fff;">
