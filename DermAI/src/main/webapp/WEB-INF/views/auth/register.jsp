            ...
            <div class="col-md-7 col-lg-5">
                <div class="card shadow-sm border-0 rounded-4 p-4 p-md-5 h-100">
                    ...
                    <form action="${pageContext.request.contextPath}/auth/register" method="post">
                        ...
                        <!-- Phone (contact only) -->
                        <div class="mb-3">
                            <label class="form-label text-muted fw-semibold small">Số điện thoại liên hệ (tuỳ chọn)</label>
                            <div class="input-group">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fa-solid fa-phone"></i></span>
                                <input type="text" name="phone" class="form-control border-start-0 ps-0" placeholder="Không dùng để đăng nhập" value="${reg_phone}" maxlength="20">
                            </div>
                        </div>
                        ...
                        <!-- Submit -->
                        <button type="submit" class="btn btn-skin w-100 fw-bold mb-3">Tạo tài khoản</button>
                        ...
                        <a href="${pageContext.request.contextPath}/auth/google" class="btn btn-outline-dark w-100 fw-bold rounded-pill">
                            <img src="https://cdn-icons-png.flaticon.com/512/2991/2991148.png" width="20" class="me-2" alt="Google"> Đăng ký bằng Google
                        </a>
                    </form>
