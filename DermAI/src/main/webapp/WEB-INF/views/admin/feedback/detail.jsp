                        ...
                        <div class="col-sm-9">
                            <c:choose>
                                <c:when test="${feedback.category == 'Khen'}">
                                    <span class="badge bg-success px-3 py-2"><c:out value="${feedback.category}" /></span>
                                </c:when>
                                <c:when test="${feedback.category == 'Góp ý'}">
                                    <span class="badge bg-info px-3 py-2"><c:out value="${feedback.category}" /></span>
                                </c:when>
                                <c:otherwise>
                                    <span class="badge bg-warning px-3 py-2"><c:out value="${feedback.category}" /></span>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <c:choose>
                                <c:when test="${feedback.status == 'Chưa xử lý'}">
                                    <span class="badge bg-warning px-3 py-2"><c:out value="${feedback.status}" /></span>
                                </c:when>
                                <c:when test="${feedback.status == 'Đang xử lý'}">
                                    <span class="badge bg-info px-3 py-2"><c:out value="${feedback.status}" /></span>
                                </c:when>
                                <c:otherwise>
                                    <span class="badge bg-success px-3 py-2"><c:out value="${feedback.status}" /></span>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
