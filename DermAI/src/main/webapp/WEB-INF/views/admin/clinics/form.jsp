    ...
    <input type="hidden" name="csrf_token" value="${sessionScope.csrfToken}">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="url" name="website" class="form-control" value="${clinic.website}" placeholder="https://">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-bold">Rating</label>
                        <input type="number" name="rating" class="form-control" value="${clinic.rating}" min="0" max="5" step="0.1">
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="isActive" id="isActive" value="1"
                                       ${clinic.active ? 'checked' : ''}>
                                <label class="form-check-label" for="isActive">Active (shown on public list/map)</label>
                            </div>
                        </div>
                    </c:if>
                </div>
