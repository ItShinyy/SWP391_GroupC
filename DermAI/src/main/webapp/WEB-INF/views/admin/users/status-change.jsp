...
<div class="container-fluid pt-4 px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="${pageContext.request.contextPath}/admin/users?segment=${empty segment ? 'regular' : segment}" class="btn btn-outline-secondary">
        ...
        <div class="col-md-5">
            <div class="card shadow-sm border-0 rounded-3 mb-4">
                <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-0">
                    <h6 class="fw-bold text-dark"><i class="fa-solid fa-user me-2 text-primary"></i> Thông Tin Tài Khoản</h6>
                </div>
                    ...
                    <table class="table table-borderless table-sm">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-secondary">${targetUser.role}</span></td>
                            </tr>
                            <tr>
    ...
    <input type="hidden" name="csrf_token" value="${sessionScope.csrfToken}">
                        ...
                        <input type="hidden" name="segment" value="${empty segment ? 'regular' : segment}">
