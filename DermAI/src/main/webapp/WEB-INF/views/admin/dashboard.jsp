...
<div class="container-fluid pt-4 px-4">
    ...
    <!-- Billing / medical coherence -->
    <div class="row g-4 mb-4">
        <div class="col-md-3">
            <div class="card bg-white border-0 shadow-sm rounded p-3">
                <p class="mb-1 text-muted small fw-semibold">Hóa đơn chưa thanh toán</p>
                <h5 class="mb-0 fw-bold" id="kpi-unpaid-invoices">—</h5>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-white border-0 shadow-sm rounded p-3">
                <p class="mb-1 text-muted small fw-semibold">Hóa đơn đã thanh toán</p>
                <h5 class="mb-0 fw-bold" id="kpi-paid-invoices">—</h5>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-white border-0 shadow-sm rounded p-3">
                <p class="mb-1 text-muted small fw-semibold">Thanh toán thành công</p>
                <h5 class="mb-0 fw-bold" id="kpi-success-payments">—</h5>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-white border-0 shadow-sm rounded p-3">
                <p class="mb-1 text-muted small fw-semibold">Hồ sơ y tế hoàn tất</p>
                <h5 class="mb-0 fw-bold" id="kpi-medical-completed">—</h5>
            </div>
        </div>
    </div>
...
<script>
    ...
    function renderDashboard(data) {
        ...
        document.getElementById('kpi-success-payments').textContent = data.successPayments || 0;
        document.getElementById('kpi-medical-completed').textContent = data.medicalReportsCompleted || 0;
