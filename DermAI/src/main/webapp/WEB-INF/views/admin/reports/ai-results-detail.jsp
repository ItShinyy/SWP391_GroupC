...
<div class="container-fluid pt-3 pb-5">
    ...
    <div class="mb-4">
        ...
        <h3 class="page-title mb-1 fw-bold">Chi Tiết Báo Cáo Sàng Lọc</h3>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <span class="badge bg-primary bg-opacity-10 text-primary border border-primary px-2 py-1 fs-6">
                            <c:set var="confPct" value="${report.confidenceScore <= 1 ? report.confidenceScore * 100 : report.confidenceScore}"/>
                            <fmt:formatNumber value="${confPct}" maxFractionDigits="1"/>%
                        </span>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <div class="border rounded p-2 bg-light d-inline-block">
                            <c:choose>
                                <c:when test="${not empty report.inputImageObjectKey}">
                                    <img src="${pageContext.request.contextPath}/reports/${report.id}/media/input" alt="Diagnosis Image" class="img-fluid rounded" style="max-height: 300px; object-fit: contain;">
                                </c:when>
                                <c:otherwise>
                        ...
                        <c:if test="${not empty report.eigencamObjectKey}">
                            <div class="mt-3">
                                <div class="text-muted small fw-bold text-uppercase mb-2">EigenCAM</div>
                                <img src="${pageContext.request.contextPath}/reports/${report.id}/media/eigencam" alt="AI explanation heatmap" class="img-fluid rounded border" style="max-height: 300px; object-fit: contain;">
                            </div>
                        </c:if>
                    </div>
                </div>
