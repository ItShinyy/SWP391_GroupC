...
<div class="container-fluid admin-page admin-page--fit">
    <div class="table-container bg-white shadow-sm rounded-4 p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="page-title">Kết Quả Sàng Lọc AI</h1>
        </div>
                            ...
                            <c:forEach var="r" items="${reports}">
                                <tr>
                                    ...
                                    <td class="font-weight-bold
                                        ...
                                        <c:set var="confPct" value="${r.confidenceScore <= 1 ? r.confidenceScore * 100 : r.confidenceScore}"/>
        ...
        <!-- Pagination -->
        <c:set var="pageQuery" value="&amp;search=${param.search}&amp;risk=${param.risk}&amp;sort=${param.sort}" scope="request"/>
