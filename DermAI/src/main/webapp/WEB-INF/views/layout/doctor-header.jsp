...
<html lang="vi">
    <head>
        ...
        <title>DermAI - Bác Sĩ Portal</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-custom sticky-top">
            <div class="container-fluid px-4">
                ...
                <div class="d-flex align-items-center gap-3">
                    <a class="navbar-brand d-flex align-items-center fw-bold m-0" href="${pageContext.request.contextPath}/doctor/dashboard">
                        <i class="fa-solid fa-leaf brand-leaf-doctor me-2 fs-4"></i>
                        <span class="fs-4 brand-text-doctor">DermAI</span>
                    </a>
                    ...
                    <ul class="navbar-nav ms-auto align-items-lg-center">
                        ...
                        <li class="nav-item dropdown mt-3 mt-lg-0">
                            <button class="nav-link profile-dropdown-toggle dropdown-toggle w-100 text-start" type="button" data-bs-toggle="dropdown">
                                ...
                                <c:set var="fallbackIcon" value="fa-solid fa-user-doctor" scope="request"/>
