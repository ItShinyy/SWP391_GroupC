...
<head>
    ...
    <style>
        ...
        .navbar-custom .nav-link::after {
            ...
            width: 0;
            height: 2px;
            background: linear-gradient(90deg, #146c43, #198754, #20c997); /* green gradient */
            transition: all 0.3s ease;
...
<nav class="navbar navbar-expand-lg navbar-custom sticky-top">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center gap-3">
            <a class="navbar-brand d-flex align-items-center fw-bold m-0" href="${pageContext.request.contextPath}/home">
            ...
            <c:if test="${not empty sessionScope.user}">
                <c:choose>
                    <c:when test="${sessionScope.user.role == 'DOCTOR'}">
                        <span class="brand-role-badge">Bác Sĩ</span>
                    </c:when>
                    <c:when test="${sessionScope.user.role == 'ADMIN'}">
                        <span class="brand-role-badge">Admin</span>
                    </c:when>
                    <c:when test="${sessionScope.user.role == 'PATIENT' || sessionScope.user.role == 'USER'}">
                        <span class="brand-role-badge">Bệnh Nhân</span>
                    </c:when>
                    <c:otherwise>
                        <span class="brand-role-badge"><c:out value="${sessionScope.user.role}"/></span>
                    </c:otherwise>
                </c:choose>
            </c:if>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="${pageContext.request.contextPath}/patient/diagnose">Sàng lọc AI</a>
                </li>
                <li class="nav-item">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:if test="${sessionScope.user.role == 'USER' or sessionScope.user.role == 'PATIENT'}">
                            <li class="nav-item me-lg-1">
                                <a id="notificationLink" class="nav-link position-relative" href="${pageContext.request.contextPath}/patient/notifications" aria-label="Thông báo">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom mt-2 border-0 shadow-sm">
                                ...
                                <c:if test="${sessionScope.user.role == 'DOCTOR'}">
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/doctor/dashboard">
                                            <i class="fa-solid fa-stethoscope fa-fw me-2 text-muted"></i> Trang Quản Trị Bác Sĩ
                                        </a>
                                    </li>
                                    <li><hr class="dropdown-divider"></li>
                                </c:if>
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/patient/reports">
                                        <i class="fa-solid fa-robot fa-fw me-2 text-muted"></i> Kết quả sàng lọc
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/patient/feedback">
                                        <i class="fa-regular fa-comment-dots fa-fw me-2 text-muted"></i> Đánh giá của tôi
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/patient/issue-report">
                                        <i class="fa-solid fa-life-ring fa-fw me-2 text-muted"></i> Báo sự cố
                                    </a>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
