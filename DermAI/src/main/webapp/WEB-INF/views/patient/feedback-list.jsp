                                    ...
                                    <div class="mb-3">
                                        <c:choose>
                                            <c:when test="${feedback.rating >= 4}">
                                                <span class="badge bg-success px-3 py-2">${feedback.rating}/5</span>
                                            </c:when>
                                            <c:when test="${feedback.rating >= 3}">
                                                <span class="badge bg-warning px-3 py-2">${feedback.rating}/5</span>
                                            </c:when>
                                            <c:otherwise>
                                                <span class="badge bg-danger px-3 py-2">${feedback.rating}/5</span>
                                            </c:otherwise>
                                        </c:choose>
