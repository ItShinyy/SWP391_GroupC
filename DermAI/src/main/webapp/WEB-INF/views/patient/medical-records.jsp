...
<style>
    ...
    .records-heading { font-size: clamp(2rem, 3vw, 2.45rem); white-space: nowrap; }
    .person-select { width: min(360px, 100%); flex: 0 1 360px; }
    ...
    @media (max-width: 767.98px) {
        .records-heading { white-space: normal; }
        .person-select { width: 100%; flex-basis: 100%; }
    }
</style>
        ...
        <div class="medical-records-card bg-white shadow-sm p-3 p-lg-4">
            <form method="get" action="${pageContext.request.contextPath}/patient/medical-records">
                <div class="d-flex flex-column flex-md-row align-items-md-center gap-3 mb-4">
                    <h1 class="records-heading mb-0">Hồ sơ bệnh án của</h1>
                ...
                <div class="filter-card p-3 mb-4">
                    <div class="row g-3 align-items-end">
                        <div class="col-12 col-lg-3">
                            <label class="form-label fw-semibold" for="medicalSearch">Chẩn đoán lâm sàng hoặc triệu chứng</label>
