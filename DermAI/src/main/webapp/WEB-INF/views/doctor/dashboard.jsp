                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${apt.confidenceScore > 0}">
                                                <c:set var="confPct" value="${apt.confidenceScore <= 1 ? apt.confidenceScore * 100 : apt.confidenceScore}"/>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="progress" style="width: 60px; height: 6px;">
                                                        <div class="progress-bar bg-primary" style="width: ${confPct}%"></div>
                                                    </div>
                                                    <span class="fw-bold text-primary" style="font-size: 0.85rem;">
                                                        <fmt:formatNumber value="${confPct}" pattern="#0.0"/>%
                                                    </span>
                                                </div>
                                            </c:if>
                                            <c:if test="${apt.confidenceScore == 0}">
