    ...
    <div class="container mt-5">
        <div class="row align-items-center mb-5">
            ...
            <div class="col-md-6 text-md-end">
                <a href="${pageContext.request.contextPath}/global/clinics/map" class="btn btn-primary rounded-pill px-4">
                    <i class="fa-solid fa-map-location-dot me-2"></i>Xem trên bản đồ
                </a>
            </div>
        </div>
                    ...
                    <div class="card h-100 border-0 shadow-sm rounded-4 hover-shadow transition">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <a href="${pageContext.request.contextPath}/global/clinics/detail?id=${clinic.id}" class="btn btn-outline-primary btn-sm rounded-pill px-3">Chi tiết</a>
                            </div>
                        </div>
                    </div>
                </div>
