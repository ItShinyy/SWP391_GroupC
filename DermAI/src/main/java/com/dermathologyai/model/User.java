...
/**
 * Represents a user in the DermAI system.
 */
public class User {
    private String id;
    ...
    private String role; // PATIENT, ADMIN, DOCTOR, USER
    ...
    /** Public self-registration always becomes PATIENT. */
    public void assignRegisteredPatientRole() {
        this.role = "PATIENT";
    }

    /** PATIENT or legacy USER (compat). */
    public boolean isPatient() {
        return "PATIENT".equals(role) || "USER".equals(role);
    }
