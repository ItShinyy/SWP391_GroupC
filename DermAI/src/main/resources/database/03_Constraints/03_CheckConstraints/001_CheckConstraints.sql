...
GO
ALTER TABLE [dbo].[notifications]  WITH CHECK ADD  CONSTRAINT [CHK_notifications_type] CHECK  (([type]='APPOINTMENT_REMINDER' OR [type]='APPOINTMENT_RESCHEDULED' OR [type]='DOCTOR_CHANGED' OR [type]='APPOINTMENT_CANCELLED' OR [type]='PAYMENT_EXPIRED' OR [type]='PAYMENT_FAILED' OR [type]='PAYMENT_SUCCESS' OR [type]='PAYMENT_PENDING' OR [type]='APPOINTMENT_COMPLETED' OR [type]='SCREENING_RESULT_VISIBLE' OR [type]='FEEDBACK_REPLIED' OR [type]='ISSUE_REPORT_UPDATED'))
GO
