...
<head>
    ...
    <title>SkinAI - AI Dermatology Diagnosis</title>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center gap-4">
            <a class="navbar-brand d-flex align-items-center fw-bold text-dark m-0" href="${pageContext.request.contextPath}/home">
                ...
                <span class="fs-4" style="font-family: 'Fragment Mono', sans-serif;">Skin<span class="text-dark">AI</span></span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item ms-lg-2">
                    <a class="nav-link ${pageContext.request.requestURI.contains('home') ? 'active' : ''}" href="${pageContext.request.contextPath}/home">Trang Chủ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${pageContext.request.requestURI.contains('diagnose') ? 'active' : ''}" href="${pageContext.request.contextPath}/patient/diagnose">Chẩn Đoán AI</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${pageContext.request.requestURI.contains('articles') ? 'active' : ''}" href="${pageContext.request.contextPath}/articles">Bài Viết</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${pageContext.request.requestURI.contains('clinics') ? 'active' : ''}" href="${pageContext.request.contextPath}/clinics">Phòng Khám</a>
                </li>
