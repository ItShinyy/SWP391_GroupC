                    ...
                    <form action="${pageContext.request.contextPath}/auth/login" method="post">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <label class="form-label text-muted fw-semibold small mb-0">Mật khẩu</label>
                                <a href="#" class="text-decoration-none small" style="color: var(--skin-secondary);">Quên mật khẩu?</a>
                            </div>
