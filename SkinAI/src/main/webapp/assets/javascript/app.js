...
const MAPTILER_API_KEY = 'DQhKue8zixGpuVf943EY';
...
const GEOAPIFY_CONFIG = {
    ...
    tileUrl: 'https://api.maptiler.com/maps/streets-v4/{z}/{x}/{y}.png?key=' + MAPTILER_API_KEY,
...
function addMapTilerTileLayer() {
    L.tileLayer(GEOAPIFY_CONFIG.tileUrl, {
