...
public class FeedbackDAO extends DBContext {
    ...
    public String create(Feedback feedback) {
        ...
        String sql = "INSERT INTO feedbacks "
                + "(id, patient_id, appointment_id, rating, category, content, status, created_at, updated_at) "
    ...
    public boolean update(Feedback feedback) {
        return executeUpdate(
                "UPDATE feedbacks SET rating = ?, category = ?, content = ?, updated_at = SYSDATETIME() "
    ...
    public boolean updateStatus(String id, String status) {
        return executeUpdate(
                "UPDATE feedbacks SET status = ?, updated_at = SYSDATETIME() WHERE id = ?",
                status, id);
    }

    public boolean updateReply(Feedback feedback) {
        return executeUpdate(
                "UPDATE feedbacks SET admin_reply = ?, replied_at = SYSDATETIME(), status = ?, "
