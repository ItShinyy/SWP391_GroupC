...
public class RegistrationCache {
    ...
    public static class PendingRegistration {
        private String token; // The session UUID
        private String expectedOtp; // The 6-digit OTP
        private User user;
        ...
        public String getExpectedOtp() { return expectedOtp; }
        public void setExpectedOtp(String expectedOtp) { this.expectedOtp = expectedOtp; }
     ...
     */
    public static void put(String token, String expectedOtp, User user, boolean isPhone) {
        cleanUp(); // Optionally clean up expired entries periodically
        cache.put(token, new PendingRegistration(token, expectedOtp, user, isPhone));
    }
