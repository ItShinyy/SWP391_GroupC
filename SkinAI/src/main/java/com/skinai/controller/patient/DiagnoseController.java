...
import com.skinai.service.AIService;
import com.skinai.util.StorageUtil;
import com.skinai.util.ValidationUtil;
...
public class DiagnoseController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            // Save file
            String relativeUrl = StorageUtil.saveFile(filePart, uploadPath);
            if (relativeUrl == null) {
